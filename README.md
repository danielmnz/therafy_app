...
sequenceDiagram
    ...
    participant M as AssistanceModel
    ...
    alt Éxito
        UI-->>Usuario: Historial actualizado
    else Error
...
stateDiagram
    ...
    ConsultandoFirebase --> MostrandoPacientes : OK
    ConsultandoFirebase --> ErrorConexion : Error

    ErrorConexion --> ConsultandoFirebase : Reintentar
